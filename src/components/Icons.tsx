...
export function LinkIcon({ type, className = "w-5 h-5" }: { type: LinkIconType; className?: string }) {
  switch (type) {
    case "spreadsheet":
      return (
...
export function ChevronIcon({ direction = "right", className = "w-4 h-4" }: { direction?: "left" | "right" | "up" | "down"; className?: string }) {
...
export function LinkListIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <line x1="8" y1="6" x2="21" y2="6" /><line x1="8" y1="12" x2="21" y2="12" /><line x1="8" y1="18" x2="21" y2="18" />
      <line x1="3" y1="6" x2="3.01" y2="6" strokeWidth="2" /><line x1="3" y1="12" x2="3.01" y2="12" strokeWidth="2" /><line x1="3" y1="18" x2="3.01" y2="18" strokeWidth="2" />
    </svg>
  );
}
