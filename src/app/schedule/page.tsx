        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          ...
          {gmailToken ? (
            <div className="flex items-center gap-2 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg">
              <span className="text-sm text-green-700 dark:text-green-300">✓ Gmail連携済み</span>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Gmail連携・リマインド設定は <a href="/email" className="text-blue-600 underline">メール設定ページ</a> から行えます。
            </p>
          )}
        </div>
      </div>
